...
const invoiceDocument = invoice => {
  ...
  const khaanFee = Number(invoice.khaan_transfer_fee_mnt || 0);
  const total = Number(invoice.total_mnt ?? amount + fee + correspondentFee + khaanFee);
